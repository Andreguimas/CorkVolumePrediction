...
ROOT_DIR = os.path.abspath(r"C:\Users\andre\Desktop\Mask RCNN\ProjetoCortica\mask\Mask_RCNN")
# Import Mask RCNN
...
class CustomDataset(utils.Dataset):
    ...
    def load_datasets(self, annotation_json, images_dir):
        """ Load the coco-like dataset from json
        Args:
            annotation_json: The path to the coco annotations json file
            images_dir: The directory holding the images referred to by the json file
...
def load_image_dataset_new(annotation_path, dataset_path):
    dataset_train = CustomDataset()
    dataset_train.load_datasets(annotation_path, dataset_path)
    dataset_train.prepare()
    return dataset_train
